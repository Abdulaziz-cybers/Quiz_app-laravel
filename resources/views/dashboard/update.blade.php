        ...
        <main class="p-6">
            <div class="min-h-screen bg-gray-100">
                <div class="container">
                    ...
                    <!-- Main Form -->
                    <form class="space-y-4" id="quizForm" method="POST" action="{{ route('quiz-update', ['quiz' => $quiz->id]) }}">
                        @csrf
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" id="title" name="title" placeholder="Quiz Title" required
                                           class="w-full px-4 py-2 border rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{$quiz->title}}">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="timeLimit" name="timeLimit" placeholder="Time Limit" min="1" required
                                           class="px-4 py-2 border rounded-lg mt-1 block w-48 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{$quiz->time_limit}}">
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="space-y-3" data-options-container>
                                                ...
                                                <div class="flex items-center gap-4">
                                                    <input type="radio" {{$option->option_true ? 'checked' : '' }} name="questions[{{$key}}][correct]" value="{{$optionKey}}" class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                                    <input type="text" name="questions[{{$key}}][options][]" placeholder="Option 1" required
                                                           value="{{ $option->name}}"
